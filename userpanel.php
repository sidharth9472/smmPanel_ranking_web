...
<section class="page-title" style="background-image: url(images/user-panel.jpg);">
  <div class="auto-container">
    <div class="content">
      <h1>user panel<span>profile</span></h1>
      <ul class="page-breadcrumb">
          <li><a href="index.php">Home</a></li>
          <li style="letter-spacing: 2px;">&#62&#62userpanel</li>
        </ul>
    </div>
  </div>
</section>
...
<!-- ===================================== php code ===================================== -->
  ...
  <img src="upload/<?php echo $row["web_pic"]; ?>" class="img-fluid" alt="website">
  ...
  <div class="card-header profile-menu mt-3">
    <span><a href="payment.php">Add your Site</a></span> 
  </div>
   <div class="card-header profile-menu mt-3">
...
<li class="about-items">
  ...
  <span class="about-item-detail"><?php echo $row["web_pic"]; ?></span>
   ...
   <div class="profile-button">
     <button class="btn-lg btn-secondary"><a href="update_userdetails.php?pid=<?php echo $row['user_id']?>"> Edit profile</a> </button>
   </div>  
     </div>
 <div  class="card-body">
...
<i class="fas fa-window-maximize"></i>
  <span class="about-item-name">web-descrption:</span>
