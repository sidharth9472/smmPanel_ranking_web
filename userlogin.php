  ...
  <div class="auto-container">
    <div class="content">
      ...
      <ul class="page-breadcrumb">
          ...
          <li style="letter-spacing: 2px;">&#62&#62login</li>
        </ul>
    </div>
  </div>
</section>
...
<div class="col-lg-9 col-md-9 col-sm-12" >
  <section>
    <div class="row box-image">
        ...
        <h1>login</h1>
        <input type="varchar" name="user_name" placeholder="username">
        <input type="password" name="password" placeholder="password">
        <input type="submit" name="submit" value="login">
         <h5><a href="#" class="text-light">Forgot password ?</a></h5>
         <element class="text-light" >Don't have account <span>
           <a href="add_site.php">&nbspRegister here !</a>
         </span></element>
       </form>
       <?php
               ...
               if(empty($_POST['user_name']) || empty($_POST['password'])){
                 echo '<div class="alert alert-danger">All Fields must be entered.</div>';
                  ...
                  $password = md5($_POST['password']);
                   ...
                   $sql = "SELECT `user_id`, `user_name` FROM `all-user` WHERE `user_name` = '{$user_name}' AND `password` = '{$password}' ";
  ...
  style="background-image:url(images/6.jpg);width: 109%;
    margin-left: -54px;">
     <div class="auto-container">
       <!-- Fact Counter -->
